...
print(move_to(bembidions, movement_map, 14, .8, BOUNDARY_CONDITION))

# And we can simulate an entire year of movement.
for day in range(365):
    print(f"*** DAY {day + 1} ***")
    bembidions = move_to(bembidions, movement_map, 14, .8, BOUNDARY_CONDITION)
...
for day in range(365):
    print(f"*** DAY {day + 1} ***")
    bembidions2 = move_to(bembidions2, movement_map2, 14, .8, BOUNDARY_CONDITION)
...
for day in range(365):
    print(f"*** DAY {day + 1} ***")
    bembidions3 = move_to(bembidions3, movement_map2, 14, .8, BOUNDARY_CONDITION)
